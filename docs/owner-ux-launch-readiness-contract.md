...
- Starter and Pro public self-serve checkout require direct payment. Customer-facing paywall copy must show direct monthly pricing with no free-trial promise.
- Historical Stripe subscriptions may still have `trialing` status. Settings and billing status surfaces must describe those as legacy access-through rows while preserving the correct Starter or Pro entitlements.
