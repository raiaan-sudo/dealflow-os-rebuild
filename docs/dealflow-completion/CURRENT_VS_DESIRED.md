...
|---|---|---|---|
| Provenance | Core domains map to Vercel deployment `dpl_J4Ksu4n7sjwdRv8tHBTa5ARDKg9E` at the baseline SHA | Isolated implementation commit `eca85bf2d9f7038a06ca71773f5dd6e7c2ef84df`, tree `f480773f9839b739b89b907c26155a2546dd0ba1`, descends from the baseline; the documentation seal is a docs-only descendant recorded by the external bundle manifest | Clean ancestry, hashes, two exact-seal verification rounds, and signed production evidence bundle |
