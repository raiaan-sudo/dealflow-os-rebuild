...
|---|---|---|---|
| Provenance | Core domains map to Vercel deployment `dpl_J4Ksu4n7sjwdRv8tHBTa5ARDKg9E` at the baseline SHA | Isolated implementation commit `24ada6f142e1f2f9010d9362c4edd16da7742af1`, tree `7a0792e59d8dd1a151cd9cb975c863e4273fc8e2`, descends from the baseline; the documentation seal is a docs/bundle-only descendant recorded by the external bundle manifest | Clean ancestry, hashes, two exact-seal verification rounds, and signed production evidence bundle |
