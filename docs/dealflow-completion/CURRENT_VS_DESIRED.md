...
|---|---|---|---|
| Provenance | Core domains map to Vercel deployment `dpl_J4Ksu4n7sjwdRv8tHBTa5ARDKg9E` at the baseline SHA | Isolated implementation commit `b8e012b8dbd0bf20ffdcfd51646e0ca54b8edc0c`, tree `c21a16049a97cd98c460183675ee43b064932e63`, descends from the baseline; the documentation seal is a docs-only descendant recorded by the external bundle manifest | Clean ancestry, hashes, two exact-seal verification rounds, and signed production evidence bundle |
