...
|---|---|---|---|
| Provenance | Core domains map to Vercel deployment `dpl_J4Ksu4n7sjwdRv8tHBTa5ARDKg9E` at the baseline SHA | Isolated candidate branch descends from the baseline; final SHA is not yet sealed in this file | Exact final commit/tree, clean ancestry, hashes, and signed evidence bundle |
