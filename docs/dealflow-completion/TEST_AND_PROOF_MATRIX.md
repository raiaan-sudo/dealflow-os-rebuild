...
Current migration inventory: `102`
...
| Frozen recovered 80-migration PostgreSQL 17.6 foundation portfolio | `HISTORICAL_PASS` | Proves the recovered foundation and its retained oracle; it is not proof of extensions 81-102 |
| Earlier 82/87/89/90/91/98 migration tranches and the 99-migration checkpoint | `HISTORICAL_PASS` where retained | Intermediate historical milestones only; none is the exact current 102-migration seal |
...
| Integrated database | exact 102 migrations fresh and history replay, foundation+extensions equality, ACL/RLS/default-ACL oracle, idempotency, atomic failure, forward recovery, zero residue | `NOT_YET_RUN` |
...
| Database | empty-platform preflight; transactional 102-migration application; migration history; post-schema/ACL/RLS digest; idempotent replay | `NOT_YET_RUN` |
