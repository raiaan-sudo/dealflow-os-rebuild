...
| Migrations | 131 tracked SQL migrations; migration 130 rotates stale GHL embed bootstrap payloads and migration 131 adds fenced operator-repair replay without weakening production billing or provider-write gates | Current production shape and authorized upgrade remain Part 2/3 gates |
