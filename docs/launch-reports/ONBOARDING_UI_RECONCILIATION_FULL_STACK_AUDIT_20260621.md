...
- Production deploy ID: `dpl_57Me9R4duqheTWRrk978zJy5jJok`
- Deploy URL: `https://dealflow-os-rebuild-gdsmfuxlq-raiaan-sudos-projects.vercel.app`

## Domain Alignment

| Domain | Result |
| --- | --- |
| `https://app.agentdealflow.io` | `dpl_57Me9R4duqheTWRrk978zJy5jJok` |
| `https://www.agentdealflow.io` | `dpl_57Me9R4duqheTWRrk978zJy5jJok` |
| `https://agentdealflow.io` | `dpl_57Me9R4duqheTWRrk978zJy5jJok` |
...
- Verdict: `OPS_READY`
- Deploy ID in output: `dpl_57Me9R4duqheTWRrk978zJy5jJok`
- Failed jobs: 0
- Dead letters: 0
...
If rollback is needed, use the Vercel deploy immediately before `dpl_57Me9R4duqheTWRrk978zJy5jJok` from project history. Because no production DB or external provider mutation was performed by this reconciliation, rollback is limited to web deployment aliasing.
