      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <p className="df-eyebrow text-cyan-100/76">
            {mode === "guided" ? "$147 guided results" : "$297 autonomous results"}
          </p>
          <h3 className="mt-2 text-2xl font-semibold tracking-[-0.05em]">
          ...
          <div>
            ...
            <p className="mt-3 max-w-4xl text-sm leading-7 text-white/66">
              ...
              {planTier === "pro"
                ...
                : " Starter keeps recommendations guided while still allowing launch access."}
            </p>
          </div>
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-2">
          <DifferenceCard
            ...
            items={[
              ...
              "Meta launch access is included while optimization execution stays manual",
            ]}
          />
          <DifferenceCard
