...
export const ACCOUNT_DELETION_COPY: Record<ProductLocale, AccountDeletionCopy> = {
  en: {
    ...
    email: "Account email", password: "Current password", typePhrase: "Type", acknowledgement: "I understand that access is suspended immediately and deletion becomes irreversible once retained-data processing begins.",
  ...
  fr: {
    ...
    email: "Courriel du compte", password: "Mot de passe actuel", typePhrase: "Saisissez", acknowledgement: "Je comprends que l'accès est suspendu immédiatement et que la suppression devient irréversible lorsque le traitement des données conservées commence.",
  ...
  es: {
    ...
    email: "Correo de la cuenta", password: "Contraseña actual", typePhrase: "Escribe", acknowledgement: "Entiendo que el acceso se suspende de inmediato y que la eliminación se vuelve irreversible cuando comienza el tratamiento de los datos retenidos.",
