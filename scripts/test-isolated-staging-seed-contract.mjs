...
assert.match(source, /exactMigrationChainRequired: 131/);
assert.match(source, /20260817223000_add_fenced_ghl_operator_repair_replay\.sql/);
...
assert.match(successorContract, /PRESERVED_ZERO_SPEND_SYNTHETIC_GHL_AUTHORITY/);
assert.match(successorContract, /Preserved synthetic GHL sandbox authority did not match its exact bounded profile/);
assert.match(successorContract, /rawCredentialsPersisted: false/);
