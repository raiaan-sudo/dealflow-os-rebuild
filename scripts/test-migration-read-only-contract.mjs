...
console.log(
  "Migration read-only contract passed: read-only SQL is mutation-free, the 14-gate foundation and prior-103/104/120/121/122 proofs remain predecessor-only, and the unsealed 123-migration successor remains NO_GO pending exact seal, isolated staging, drain, and production proof.",
);
