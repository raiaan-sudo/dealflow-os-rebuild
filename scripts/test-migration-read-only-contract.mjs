...
console.log(
  "Migration read-only contract passed: read-only SQL is mutation-free, the 14-gate foundation and prior-103/104/120/121/122/123 proofs remain predecessor-only, and the 128-migration candidate remains NO_GO pending exact seal, isolated staging, drain, and production proof.",
);
