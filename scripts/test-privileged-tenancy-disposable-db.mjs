...
const FINAL_MIGRATION = "20260717090000_create_canonical_lead_outcome_ledger.sql";
...
try {
  assert.equal(migrations.length, 120, "proof expects the exact 120-migration candidate");
