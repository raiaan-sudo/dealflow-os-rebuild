...
const FINAL_MIGRATION = "20260727020000_fix_ghl_provisioning_lease_revision_fencing.sql";
...
try {
  assert.equal(migrations.length, 129, "proof expects the exact 129-migration candidate");
