...
function runOfflineChecks() {
  ...
  assertIncludes(staticAdTemplateRenderer, "This visual needs a cleaner background", "Rejected image customer copy", "bad provider images show clean customer-safe retry copy instead of raw QA/provider language");
  ...
  assertIncludes(previewPage, "AI UGC video concepts", "Preview video concept review", "preview page surfaces AI UGC video concepts before launch");
