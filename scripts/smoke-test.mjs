...
function runOfflineChecks() {
  ...
  assertIncludes("src/lib/services/canonical-campaign.ts", "asset.providerName === \"higgsfield_marketing_studio\"", "Canonical finished static provider fallback", "Creative Studio recognizes Higgsfield finished ads persisted with providerName/generationMethod provenance");
  assertIncludes("src/lib/services/canonical-campaign.ts", "asset.assetRole === \"final_static_ad\"", "Canonical finished static role guard", "Creative Studio does not promote non-final Higgsfield source/background rows");
  assertIncludes("src/app/(app)/build/creatives/page.tsx", "generationMethod: ad.generationMethod ?? null", "Creative Studio finished static generation method prop", "client readiness receives Higgsfield generation method provenance");
  assertIncludes("src/app/(app)/build/creatives/page.tsx", "assetRole: ad.assetRole ?? null", "Creative Studio finished static role prop", "client readiness receives final static ad role provenance");
  assertIncludes("src/components/campaign/static-creative-preview-card.tsx", "generationMethod?: string | null", "Static preview card finished static generation method prop", "preview cards receive Higgsfield generation method provenance");
  assertIncludes("src/components/campaign/static-creative-preview-card.tsx", "assetRole={assetRole}", "Static preview card finished static role pass-through", "preview cards pass final static role provenance into readiness rendering");
  assertIncludes("src/app/(app)/build/creatives/creative-wizard.tsx", "generationMethod={displayCreative.generationMethod}", "Creative wizard finished static card generation method prop", "selected/review creative cards receive Higgsfield generation method provenance");
  assertIncludes("src/app/(app)/build/creatives/creative-wizard.tsx", "assetRole={displayCreative.assetRole}", "Creative wizard finished static card role prop", "selected/review creative cards receive final static role provenance");
  assertIncludes("src/app/(app)/preview/page.tsx", "generationMethod={selectedAd.generationMethod}", "Preview selected static generation method prop", "Preview cards render stored Higgsfield finished rasters instead of template fallback cards");
  assertIncludes("src/app/(app)/preview/page.tsx", "assetRole={selectedAd.assetRole}", "Preview selected static role prop", "Preview cards receive final static role provenance for launch-readiness badges");
  assertIncludes("src/app/(app)/launch/page.tsx", "generationMethod={selectedCreative.generationMethod}", "Launch selected static generation method prop", "Launch cards render stored Higgsfield finished rasters instead of template fallback cards");
  assertIncludes("src/app/(app)/launch/page.tsx", "assetRole={selectedCreative.assetRole}", "Launch selected static role prop", "Launch cards receive final static role provenance for launch-readiness badges");
