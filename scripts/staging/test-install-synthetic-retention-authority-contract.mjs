...
assert.match(source, /syntheticDeletionPostResetRequestCount/);
assert.match(source, /syntheticDeletionPostResetSuspensionCount/);
assert.match(source, /syntheticPrivacyPostResetRequestCount/);
