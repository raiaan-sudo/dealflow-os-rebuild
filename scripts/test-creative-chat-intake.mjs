...
assert.match(creativeWizardUi, /Full-resolution creative files stay inside this workspace/);
...
assert.match(staticCreativePreviewCardUi, /Full-resolution creative files stay inside this workspace and are used through the launch workflow/);
